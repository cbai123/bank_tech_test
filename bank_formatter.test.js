...
describe('BankFormatter class', () => {
  ...
  it('accepts an array of multiple bank objects and formats it correctly', () => {
    ...
    bankFormatter.format([{date: '16/01/2023', deposit: 100, withdrawal: "", balance: 250}, {date: '15/01/2023', deposit: "", withdrawal: 50, balance: 150}, {date: '14/01/2023', deposit: 200, withdrawal: "", balance: 200}])
  
    expect(logSpy).toHaveBeenCalled();
    expect(logSpy).toHaveBeenCalledTimes(4);
    expect(logSpy).toHaveBeenCalledWith('date || credit || debit || balance');
    expect(logSpy.mock.calls).toContainEqual(['16/01/2023 || 100 ||  || 250']);
