...
describe('BankFormatter class', () => {
  ...
  it('accepts an array of one BankTransaction object and formats it correctly', () => {
  ...
  it('accepts an array of multiple BankTransaction objects and formats it correctly', () => {
    const bankFormatter = new BankFormatter()
